      ...
      <section className="min-h-screen bg-slate-200 text-center font-sans">
          ...
          <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-300">
            <ul className="space-y-3">
              <li>
                <Link
                  to="/Vehicles"
                  className="flex items-center p-2 text-base font-medium text-black rounded-lg hover:text-blue-600 hover:bg-gray-100"
                >
        ...
        <div className="p-4 sm:ml-64">
          <div className="relative flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-800">Rented Vehicles</h1>
