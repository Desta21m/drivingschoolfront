    ...
    const fetchCourses = async () => {
      try {
        const response = await axios.get(
          'http://localhost:8080/api/courses/today_lessons'
        );
      ...
      <section className="min-h-screen bg-slate-200 font-sans text-center">
        ...
        <div className="p-4 sm:ml-64">
          <div className="relative flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-800">Today's Lessons</h1>
...
export default CourseTodayLesson;
